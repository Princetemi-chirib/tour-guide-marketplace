...
export function GuideDashboardPage() {
  ...
  return (
    <ToursAppShell>
      <div className="tours-dashboard guide-dashboard">
        <h1 className="tours-dashboard__title">Guide dashboard</h1>
        <p className="tours-dashboard__lead">Add and edit your tours, and view traveler bookings.</p>
